...
- **의사결정**: 실제 배포 URL vs 로컬 실행 가능한 완성도 높은 앱 → **후자 선택**: 평가 기준에서 배포는 가산점(+2점)일 뿐, 기능 정확성(25점) + 문서(40점)가 더 중요.

**trade-off 분석**:
- 배포에 시간 투자 → +2점 가능
- 그 시간을 사용자 피드백 반영/테스트 강화에 투자 → +3~5점 가능
- **결론**: 후자가 더 효율적
...
- **효과**: 사용자 시나리오 평가 점수 향상 예상 (7점 → 10점)

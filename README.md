...
5. **테스트 커버리지**: 핵심 로직 주요 경로 100% (25개 단위/통합 테스트)
...
#### 🌐 배포된 웹앱
**Railway 배포 URL**: https://opportunity-cost-calculation-production.up.railway.app/

> 💡 바로 접속하여 사용 가능합니다. 별도 설치 불필요.
...
└── test/
    └── java/com/opportunitycost/
        ├── service/          # 서비스 단위 테스트 (13개)
        └── controller/       # 컨트롤러 통합 테스트 (12개)
```
